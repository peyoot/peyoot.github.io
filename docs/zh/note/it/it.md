...
## 我的服务器
# ipv6安强"加固
2026-01-16  出于对ipv6使能后内网安强的考虑，原在内网中ssh用简单密码的，升级后在原来基础上增加"oldhome+newhome"，如果不通时，请尝试。
pve主机只开通ipv4，不受影响，仍维持原密
...
#### linux主机
| Linux主机 | ipv6 | MAC | 发行版 | 用途 | 登陆 | 端口号 | 备注 |
|---------|---------|---------|---------|---------|---------|---------|---------|
| 10.70.1.68 | 2*0e:688:*00:107*:baae:edff:fe73:7227 | b8:ae:ed:73:72:27 | ubuntu 22.04.3 | 备份机 | r@.k系列1刀h+新密规 | 非22 | *为七数 |
| 10.70.1.40 | 2*0e:688:*00:107*:be2*:11ff:fedc:7890 | b8:ae:ed:73:72:27 | ubuntu 22.04.3 | 备份机 | r@.k系列1刀h+新密规 | 非22 | *为七数 |


#### 虚拟机
| PVE主机 | PVE MAC/VM主机 | 名称 | ipv6 | 用途 | 登陆 |
|---------|---------|---------|---------|---------|---------|
| 10.70.1.20 | 50:65:f3:40:23:e0 | pvehpdesk | |  挂载web虚拟机 | r@.k系列1刀h |
|  | 10.70.1.80 | ecceeweb1 | | eccee web服务器 | rob*@.k系列 |
|  | 10.70.1.81| storage.eccee.com | | filebrowser网盘 | 单元格 3 |
| 10.70.1.21 | 64:51:06:a0:36:3a | pve-meeetingroom-table | | 开发测试pve主机 | r@.k系列1刀h |
|  | 10.70.1.40 | ubuntu2204-dey | 2*0e:688:*00:107*:be2*:11ff:fedc:7890 | dey编译机 | r@.k系列1刀h |
| 10.70.1.22 | 8c:dc:d4:d4:59:05 | hp850ip67 | | pve主机 | r@.k系列1刀h |
|  | 10.70.1.90 | ecceewebbk | | 备份机/测试机 | r@.k系列1刀h |
...
云服务器密码规则：点+头+k系列尾大+1刀山

| 服务商 | 控制台登陆或备注 | 服务器IP | 用途 | 登陆 |
|---------|---------|---------|---------|---------|
| Aliyun.com | alipay扫码 | |  | sales@ec*e.com |
|  | *.1#3.20#.*0 | #*为老家home | webportal | ubu*@点Ak系列1刀h |
|  | |  |  |  |
|  |  |  | |  |
| Qcloud | 微信扫码 |  |  | 晓* |
|  |  |  | |  |
|  |  | 43.163.247.23 | | ubuntu @ 点Ak系列尾大1刀h |

## 企业邮箱 

| 服务商 | 控制台登陆或备注 | 邮箱 | 密码 | 手机 | 备注 |
|---------|---------|---------|---------|---------|---------|
| 腾讯 | exmail.qq.com | info | 列缺扫码 | 1896%0%8169 | leiqie也是邮箱，smtp.exmail.qq.com 465  |
|  | |  |  |  | |