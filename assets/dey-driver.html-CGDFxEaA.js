import{_ as e,o as i,c as n,b as d}from"./app-BgPEY49s.js";const s={},l=d(`<h1 id="dey-aio驱动开发示例" tabindex="-1"><a class="header-anchor" href="#dey-aio驱动开发示例"><span>DEY AIO驱动开发示例</span></a></h1><p>Linux源码树在~/deyaio-rtnodemo/dey5.0/workspace/ccmp25dvkrt/tmp/work/ccmp25_dvk-dey-linux/linux-dey/6.6/git 而内核自带的设备驱动目录是~/deyaio-rtnodemo/dey5.0/workspace/ccmp25dvkrt/tmp/work/ccmp25_dvk-dey-linux/linux-dey/6.6/git/drivers/，每个目录下有相应的Makefile和Kconfig。</p><h2 id="usb扩展串口的驱动集成" tabindex="-1"><a class="header-anchor" href="#usb扩展串口的驱动集成"><span>USB扩展串口的驱动集成</span></a></h2><p>本文以CH343的驱动开发为例，其它的驱动可以参考实现。CH343可以支持系统内置的ACM驱动，默认该内核选项已经打开：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>bitbake -c menuconfig virtual/kernel
配置路径：
