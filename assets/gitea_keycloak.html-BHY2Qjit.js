import{_ as e,o as n,c as i,b as s}from"./app-nyDMWEXJ.js";const d={},l=s(`<h2 id="gitea和keycloak-sso系统搭建" tabindex="-1"><a class="header-anchor" href="#gitea和keycloak-sso系统搭建"><span>gitea和keycloak sso系统搭建</span></a></h2><p>在portainer中编排这个服务，</p><ol><li>创建external网络npm Portainer → Networks → Add network Name = npm , Driver = bridge , Enable “Manual network creation” 这和用docker network创建的区别在于它的attachable是&quot;true&quot;</li></ol><p>2.新建stack Portainer → Stacks → Add stack</p><table><thead><tr><th>字段</th><th>填写内容</th></tr></thead><tbody><tr><td><strong>Name</strong></td><td><code>git-keycloak</code></td></tr><tr><td><strong>Build method</strong></td><td>Web editor</td></tr><tr><td><strong>Web editor</strong></td><td>贴下面的 compose 文件</td></tr><tr><td><strong>Environment variables</strong></td><td><strong>点 &quot;Advanced mode&quot;</strong> → 逐行添加（见下表）</td></tr></tbody></table><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>KC_ADMIN=admin
