import{_ as e,o as t,c as i,b as a}from"./app-nyDMWEXJ.js";const n={},l=a(`<h1 id="压缩指定大小分卷" tabindex="-1"><a class="header-anchor" href="#压缩指定大小分卷"><span>压缩指定大小分卷</span></a></h1><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>tar -cJf - -C ~ deyaio-ccmp25plc |split -b 999M - deyaio-ccmp25plc.tar.xz.
命令详解：
