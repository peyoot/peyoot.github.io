import{_ as t,o as e,c as n,b as i}from"./app-CaF6vbjI.js";const a={},s=i(`<h1 id="ubuntu-上高效打包-适度压缩-安全传输" tabindex="-1"><a class="header-anchor" href="#ubuntu-上高效打包-适度压缩-安全传输"><span>Ubuntu 上高效打包 + 适度压缩 + 安全传输</span></a></h1><p>推荐方案：tar（不压缩） + zstd（多线程压缩），每卷 ≤ 3.8 GiB（兼容 FAT32 / 网盘 / 邮件）</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code># 1. 进入目录的上层
cd /path/to/parent
