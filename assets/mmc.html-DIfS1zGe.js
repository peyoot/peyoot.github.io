import{_ as i,o as e,c as n,b as s}from"./app-CesSSjZu.js";const l={},d=s(`<h1 id="如何测试sd卡接口" tabindex="-1"><a class="header-anchor" href="#如何测试sd卡接口"><span>如何测试SD卡接口</span></a></h1><p>TF卡也叫Micro SD卡，通常linux下直接看lsblk，uboot下则要看mmc list</p><h1 id="官方开发套件示例" tabindex="-1"><a class="header-anchor" href="#官方开发套件示例"><span>官方开发套件示例</span></a></h1><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>NOTICE:  CPU: STM32MP255CAL Rev.Y
