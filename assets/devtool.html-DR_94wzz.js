...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,13),a=[s];function v(c,t){return i(),n("div",null,a)}const r=e(l,[["render",v],["__file","devtool.html.vue"]]),m=JSON.parse('{"path":"/zh/deyaio/devtool.html","title":"在DEY AIO环境下使用devtool进行驱动开发和调试","lang":"zh-CN","frontmatter":{"description":"在DEY AIO环境下使用devtool进行驱动开发和调试 本文旨在帮助对嵌入式系统不熟悉的用户熟悉和了解驱动程序的相关开发知识。虽然可以直接在yocto项目的tmp目录下找到相关的源代码并用bitbake -c devshell virtual/kernel来进入配置好环境的终端进行编译和测试，但这种方式需要手动管理源代码路径、生成补丁，并可能导致 ...","head":[["meta",{"property":"og:url","content":"https://peyoot.github.io/zh/deyaio/devtool.html"}],["meta",{"property":"og:title","content":"在DEY AIO环境下使用devtool进行驱动开发和调试"}],["meta",{"property":"og:description","content":"在DEY AIO环境下使用devtool进行驱动开发和调试 本文旨在帮助对嵌入式系统不熟悉的用户熟悉和了解驱动程序的相关开发知识。虽然可以直接在yocto项目的tmp目录下找到相关的源代码并用bitbake -c devshell virtual/kernel来进入配置好环境的终端进行编译和测试，但这种方式需要手动管理源代码路径、生成补丁，并可能导致 ..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"在DEY AIO环境下使用devtool进行驱动开发和调试\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[]}"]]},"headers":[],"git":{},"autoDesc":true,"filePathRelative":"zh/deyaio/devtool.md"}');export{r as comp,m as data};
