import{_ as e,o as a,c as i,b as t}from"./app-CaF6vbjI.js";const n={},s=t(`<h1 id="实时镜像的测试" tabindex="-1"><a class="header-anchor" href="#实时镜像的测试"><span>实时镜像的测试</span></a></h1><p>即使带有多种GUI和应用程序包及例程的实时镜像，仍可以得到最佳的测试效果。编译出镜像固然是要优化技巧，对已经编译好的镜像做实时任务的优化同样重要。本文以CCMP255为例，它有两个A35大核。</p><p>1、查看各中断在CPU0/CPU1上的分布</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>cat /proc/interrupts
