import{_ as i,o as e,c as n,b as s}from"./app-Gzti1wGm.js";const l={},d=s(`<h2 id="背光驱动的设备树" tabindex="-1"><a class="header-anchor" href="#背光驱动的设备树"><span>背光驱动的设备树</span></a></h2><p>https://github.com/digi-embedded/linux/blob/v6.6/stm/dey-5.0/maint/Documentation/devicetree/bindings/leds/backlight/pwm-backlight.yaml</p><h4 id="自动熄屏的正确实现方式" tabindex="-1"><a class="header-anchor" href="#自动熄屏的正确实现方式"><span>自动熄屏的正确实现方式</span></a></h4><p>这是一个典型的系统电源管理场景</p><h5 id="方案-1-systemd-logind-推荐-最简单" tabindex="-1"><a class="header-anchor" href="#方案-1-systemd-logind-推荐-最简单"><span>方案 1：systemd-logind（推荐，最简单）</span></a></h5><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code># 编辑 /etc/systemd/logind.conf
[Login]
# 空闲 5 分钟后降低亮度（省电但不熄屏）
IdleAction=ignore
IdleActionSec=5min
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,19),t=[d];function a(v,c){return e(),n("div",null,t)}const u=i(l,[["render",a],["__file","backlight.html.vue"]]),m=JSON.parse('{"path":"/zh/note/digi/dey/backlight.html","title":"","lang":"zh-CN","frontmatter":{"description":"背光驱动的设备树 https://github.com/digi-embedded/linux/blob/v6.6/stm/dey-5.0/maint/Documentation/devicetree/bindings/leds/backlight/pwm-backlight.yaml 自动熄屏的正确实现方式 这是一个典型的系统电源管理场景 方案 1：...","head":[["meta",{"property":"og:url","content":"https://peyoot.github.io/zh/note/digi/dey/backlight.html"}],["meta",{"property":"og:description","content":"背光驱动的设备树 https://github.com/digi-embedded/linux/blob/v6.6/stm/dey-5.0/maint/Documentation/devicetree/bindings/leds/backlight/pwm-backlight.yaml 自动熄屏的正确实现方式 这是一个典型的系统电源管理场景 方案 1：..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[]}"]]},"headers":[{"level":2,"title":"背光驱动的设备树","slug":"背光驱动的设备树","link":"#背光驱动的设备树","children":[]}],"git":{},"autoDesc":true,"filePathRelative":"zh/note/digi/dey/backlight.md"}');export{u as comp,m as data};
