import{_ as e,o as n,c as t,b as a}from"./app-CyV6FjEB.js";const i={},s=a(`<h1 id="weston" tabindex="-1"><a class="header-anchor" href="#weston"><span>weston</span></a></h1><p>尝试 Weston 作为 Wayland compositor，它在处理多显示器克隆模式上可能更稳定。你可以在 /etc/xdg/weston.ini 中进行类似配置：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>[core]
# Wayland socket
[shell]
