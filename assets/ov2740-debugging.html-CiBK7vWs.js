import{_ as e,o as i,c as n,b as t}from"./app-BgPEY49s.js";const d={},s=t(`<h1 id="驱动修改编译后的问题" tabindex="-1"><a class="header-anchor" href="#驱动修改编译后的问题"><span>驱动修改编译后的问题</span></a></h1><p>原始的Linux源码树下的ov2740.c 是为ACPI平台（Intel） 设计的，缺少现代Linux设备树（.of_match_table）和时钟支持所需的函数或头文件。 修改后，可编译通过，但仍然无法识别，具体表现有：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>root@ccmp25-dvk:~# dmesg | grep -i i2c
