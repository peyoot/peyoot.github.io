import{_ as t,o as e,c as n,b as i}from"./app-CnHmGEzO.js";const a={},s=i(`<h1 id="ubuntu-上高效打包-适度压缩-安全传输" tabindex="-1"><a class="header-anchor" href="#ubuntu-上高效打包-适度压缩-安全传输"><span>Ubuntu 上高效打包 + 适度压缩 + 安全传输</span></a></h1><p>推荐方案：tar（不压缩） + zstd（多线程压缩），每卷 ≤ 3.8 GiB（兼容 FAT32 / 网盘 / 邮件）</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code># 1. 进入目录的上层
cd /path/to/parent
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,5),r=[s];function d(l,c){return e(),n("div",null,r)}const u=t(a,[["render",d],["__file","linux-skill.html.vue"]]),p=JSON.parse('{"path":"/zh/note/linux-skill.html","title":"Ubuntu 上高效打包 + 适度压缩 + 安全传输","lang":"zh-CN","frontmatter":{"description":"Ubuntu 上高效打包 + 适度压缩 + 安全传输 推荐方案：tar（不压缩） + zstd（多线程压缩），每卷 ≤ 3.8 GiB（兼容 FAT32 / 网盘 / 邮件） 目标机器上还原：","head":[["meta",{"property":"og:url","content":"https://peyoot.github.io/zh/note/linux-skill.html"}],["meta",{"property":"og:title","content":"Ubuntu 上高效打包 + 适度压缩 + 安全传输"}],["meta",{"property":"og:description","content":"Ubuntu 上高效打包 + 适度压缩 + 安全传输 推荐方案：tar（不压缩） + zstd（多线程压缩），每卷 ≤ 3.8 GiB（兼容 FAT32 / 网盘 / 邮件） 目标机器上还原："}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"Ubuntu 上高效打包 + 适度压缩 + 安全传输\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[]}"]]},"headers":[],"git":{},"autoDesc":true,"filePathRelative":"zh/note/linux-skill.md"}');export{u as comp,p as data};
