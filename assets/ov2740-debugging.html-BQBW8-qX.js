import{_ as e,o as i,c as n,b as t}from"./app-BpQjmUvn.js";const d={},s=t(`<h1 id="驱动修改编译后的问题" tabindex="-1"><a class="header-anchor" href="#驱动修改编译后的问题"><span>驱动修改编译后的问题</span></a></h1><p>原始的Linux源码树下的ov2740.c 是为ACPI平台（Intel） 设计的，缺少现代Linux设备树（.of_match_table）和时钟支持所需的函数或头文件。 修改后，可编译通过，但仍然无法识别，具体表现有：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>root@ccmp25-dvk:~# dmesg | grep -i i2c
...
dmesg | tail -20
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="编译成功后的调试" tabindex="-1"><a class="header-anchor" href="#编译成功后的调试"><span>编译成功后的调试</span></a></h1><p>按官方文档来，本次调试所用的commit hash是57e6a23。</p>`,23),l=[s];function a(v,c){return i(),n("div",null,l)}const u=e(d,[["render",a],["__file","ov2740-debugging.html.vue"]]),o=JSON.parse('{"path":"/zh/note/ov2740-debugging.html","title":"驱动修改编译后的问题","lang":"zh-CN","frontmatter":{"description":"驱动修改编译后的问题 原始的Linux源码树下的ov2740.c 是为ACPI平台（Intel） 设计的，缺少现代Linux设备树（.of_match_table）和时钟支持所需的函数或头文件。 修改后，可编译通过，但仍然无法识别，具体表现有： 检查完整的I2c1设备树链路 检查驱动源码： 解决办法： 当前驱动是 I2C 驱动，但 port 是写在 设...","head":[["meta",{"property":"og:url","content":"https://peyoot.github.io/zh/note/ov2740-debugging.html"}],["meta",{"property":"og:title","content":"驱动修改编译后的问题"}],["meta",{"property":"og:description","content":"驱动修改编译后的问题 原始的Linux源码树下的ov2740.c 是为ACPI平台（Intel） 设计的，缺少现代Linux设备树（.of_match_table）和时钟支持所需的函数或头文件。 修改后，可编译通过，但仍然无法识别，具体表现有： 检查完整的I2c1设备树链路 检查驱动源码： 解决办法： 当前驱动是 I2C 驱动，但 port 是写在 设..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"驱动修改编译后的问题\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[]}"]]},"headers":[],"git":{},"autoDesc":true,"filePathRelative":"zh/note/ov2740-debugging.md"}');export{u as comp,o as data};
