import{_ as e,o as t,c as i,b as a}from"./app-Crg5dGGQ.js";const n={},l=a(`<h1 id="compiling-a-light-real-time-dey-image-with-qt-support" tabindex="-1"><a class="header-anchor" href="#compiling-a-light-real-time-dey-image-with-qt-support"><span>Compiling a light Real-time DEY Image with QT support</span></a></h1><p>To achieve better real-time performance under the QT image, some image trimming and optimization are required. After installing DEY AIO, You can check out the following repository using repo:</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>repo init -u https://github.com/peyoot/dey-aio-manifest.git -b scarthgap -m qtfb-rtnodemo.xml
